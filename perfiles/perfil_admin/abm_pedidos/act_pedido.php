...
if(empty($_GET['cod_pedido'])){
    header('location:../perfiles/perfil_admin/abm_pedidos/pedidos.php');
}

$query="SELECT * FROM pedidos WHERE cod_ped='$cod_ped'";
$sql="SELECT * FROM pedidos WHERE cod_ped='$cod_ped'";
    ...
    <div class="card" style="width: 28rem;">
      ...
      <div class="card-body">
        <form  action = update_prod.php method="post" enctype="multipart/form-data">
                      <h3 class="text-sm-center">Datos del pedido: <?php echo $cod_ped; ?></h3>
