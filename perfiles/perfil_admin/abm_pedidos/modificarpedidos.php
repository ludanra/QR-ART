  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link text-light" href="./pedidos.php">Mis Pedidos</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-light" href="./eliminarpedido.php">Eliminar Pedido</a>
        </li>
...
<br>
    ...
    <table id="pedidos" name="pedidos" class="table table-striped" style="width:100%">
        ...
        $sql="SELECT * from pedidos ORDER BY estado_ped DESC";
        ...
        <tbody>
            <tr>
                ...
                <td class="text-light"><?php echo $mostrar['estado_pedido'] ?></td>
