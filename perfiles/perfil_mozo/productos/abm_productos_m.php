...
<body>
    <nav>
        <h5 class="text-sm-center text-light">Administración De Productos <br><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-basket3" viewBox="0 0 16 16">
  ...
  <path d="M3 8.812a4.999 4.999 0 0 1 2.578-4.375l-.485-.874A6 6 0 1 0 11 3.616l-.501.865A5 5 0 1 1 3 8.812z"/>
    ...
    <div class="d-grid gap-4 col-6 mx-auto">
        ...
        <a href="./modificacionproducto_m.php" class="btn btn-warning btn-sm  text-light" type="button">Listado de productos</a>
    </div>
