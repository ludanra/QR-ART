...
<body>
    <nav>
        <h5 class="text-sm-center text-light">Administración De Extras<svg xmlns="http://www.w3.org/2000/svg" width="35" height="20" fill="currentColor" class="bi bi-cup-fill" viewBox="0 0 16 16">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex ">
           ...
           <a class="text-light "><?php echo "Usuario: "; echo $usuario;?></a>
            <a  class="d-block "><?php echo "Perfil: Mesero";?></a>
