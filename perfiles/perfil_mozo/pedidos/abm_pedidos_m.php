...
<body>
    ...
    <div class="d-grid gap-4 col-6 mx-auto">
        <a href="./pedidos_m.php" button class="btn btn-success btn-lg" type="button">Mis Pedidos</a>
        <a href="./modificarpedidos_m.php" button class="btn btn-success btn-lg" type="button">Modificar Pedido</a>
        <a href="./eliminarpedido_m.php" class="btn btn-success btn-lg" type="button">Eliminar Pedido</a>
    </div>
