...
<table id="extra" name="extra" class="table table-striped" style="width:100%">
        ...
        <tbody>
            <tr>
              <td class="text-dark"><?php echo $mostrar['nombre_extra'] ?></td>
              ...
              <td class="text-dark"><?php if($mostrar['estado_extra'] == 0){echo "INACTIVO";}else{echo "ACTIVO";} ?></td>
              <td>
              <a class= "btn btn-primary" href="update_extra_prod.php?id1=<?php echo $mostrar['nombre_extra']?>&id2=<?php echo $id_ped_sol?>&id3=<?php echo $mostrar['precio_extra'] ?>" class="table__item__link" >Agregar</a>       
              </td>
