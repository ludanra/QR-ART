    ...
    <div class="container mb-5">
        ...
        <div class="swiper mySwiper swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden ">
            <div class="swiper-wrapper" id="swiper-wrapper-de426edc421108aa6" aria-live="polite" style="transition-duration: 0ms; transform: translate3d(-294px, 0px, 0px);">
                <div class="swiper-slide" role="group" aria-label="1 / 9" style=" margin-right: 20px;">
                    <div class="card h-100">
                        <img src="assets/img/papas1.PNG" class="card-img-top" style="max-height: 150px;" alt="imageNotFound">
                        <div class="card-body">
                            <h6 class="card-title">PAPAS CHEDDAR+PANCETA+VERDEO</h6>
                        </div>
                        <div class="justify-content-end p-3">
                ...
                <div class="swiper-slide" role="group" aria-label="2 / 9" style=" margin-right: 20px;">
                    <div class="card h-100">
                        <img src="assets/img/papas2.PNG" class="card-img-top" style="max-height: 150px;" alt="imageNotFound">
                        <div class="card-body">
                            <h6 class="card-title">PAPAS HUEVO + JAMON</h6>
                        </div>
                        <div class="justify-content-end p-3">
                            <p class="card-text">$600</p>
                            <a href="#" class="btn button-custom-secondary">Agregar al pedido</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper-slide" role="group" aria-label="3 / 9" style=" margin-right: 30px;">
                    <div class="card h-100">
                        <img src="assets/img/empanadas.PNG" class="card-img-top" style="max-height: 150px;" alt="imageNotFound">
                        <div class="card-body">
                            <h6 class="card-title">EMPANADAS FRITAS</h6>
                        </div>
                        <div class="justify-content-end p-3">
                            <p class="card-text">$600</p>
                            <a href="assets/pages/detail.html" class="btn button-custom-secondary">Agregar al pedido</a>
                ...
                <div class="swiper-slide" role="group" aria-label="4 / 9" style=" margin-right: 30px;">
                    <div class="card h-100">
                        <img src="assets/img/nugets.PNG" class="card-img-top" style="max-height: 150px;" alt="imageNotFound">
                        <div class="card-body">
                            <h6 class="card-title">NUGGETS</h6>
                        </div>
                        <div class="justify-content-end p-3">
                            <p class="card-text">$600</p>
                            <a href="assets/pages/detail.html" class="btn button-custom-secondary">Agregar al pedido</a>
        ...
        <div class="swiper mySwiper swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden ">
            <div class="swiper-wrapper" id="swiper-wrapper-de426edc421108aa6" aria-live="polite" style="transition-duration: 0ms; transform: translate3d(-294px, 0px, 0px);">
                <div class="swiper-slide" role="group" aria-label="1 / 9" style=" margin-right: 30px;">
                    <div class="card h-100">
                        <img src="assets/img/pizza1.PNG" class="card-img-top" style="min-height: 150px; max-height: 150px;" alt="imageNotFound">
                        <div class="card-body">
                            <h5 class="card-title">MUZARELLA</h5>
                        </div>
                        <div class="justify-content-end p-3">
                            <p class="card-text">Indivi:$650 Grande:$850</p>
                            <a href="assets/pages/detail.html" class="btn button-custom-secondary">Agregar al pedido</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="swiper-slide" role="group" aria-label="2 / 9" style=" margin-right: 30px;">
                    <div class="card h-100">
                        <img src="assets/img/pizza2.PNG" class="card-img-top" style="min-height: 150px; max-height: 150px;" alt="imageNotFound">
                        <div class="card-body">
                ...
                <div class="swiper-slide" role="group" aria-label="3 / 9" style=" margin-right: 30px;">
                    <div class="card h-100">
                        <img src="assets/img/pizza3.PNG" class="card-img-top" style="min-height: 150px; max-height: 150px;" alt="imageNotFound">
                        <div class="card-body">
                ...
                <div class="swiper-slide" role="group" aria-label="4 / 9" style=" margin-right: 30px;">
                    <div class="card h-100">
                        <img src="assets/img/pizza4.PNG" class="card-img-top" style="min-height: 150px; max-height: 150px;" alt="imageNotFound">
                        <div class="card-body">
